...
if ( defined( 'boniPS_VERSION' ) ) {
	 ...
	 * @version 1.0
	 */
	add_filter( 'bonips_setup_hooks', 'GD_Star_boniPS_Hook' );
	function GD_Star_boniPS_Hook( $installed ) {
		$installed['gdstars'] = array(
			'title'       => __( 'GD Star Rating', 'bonips' ),
			'description' => __( 'Awards %_plural% for users rate items using the GD Star Rating plugin.', 'bonips' ),
			'callback'    => array( 'boniPS_Hook_GD_Star_Rating' )
		);
		return $installed;
	}
	 ...
	 * @version 1.0
	 */
	if ( ! class_exists( 'boniPS_Hook_GD_Star_Rating' ) && class_exists( 'boniPS_Hook' ) ) {
		class boniPS_Hook_GD_Star_Rating extends boniPS_Hook {
...
<label class="subheader" for="<?php echo $this->field_id( array( 'star_rating' => 'creds' ) ); ?>"><?php _e( 'Rating', 'bonips' ); ?></label>
<ol>
	<li>
...
<label class="subheader" for="<?php echo $this->field_id( array( 'star_rating' => 'log' ) ); ?>"><?php _e( 'Protokollvorlage', 'bonips' ); ?></label>
<ol>
	<li>
...
<label class="subheader" for="<?php echo $this->field_id( array( 'up_down' => 'creds' ) ); ?>"><?php _e( 'Up / Down Vote', 'bonips' ); ?></label>
<ol>
	<li>
...
<label class="subheader" for="<?php echo $this->field_id( array( 'up_down' => 'log' ) ); ?>"><?php _e( 'Protokollvorlage', 'bonips' ); ?></label>
<ol>
	<li>
