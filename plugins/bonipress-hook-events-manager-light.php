 ...
 * @version 1.0.1
 */
add_filter( 'bonipress_setup_hooks', 'bonipress_register_events_manager_light_hook', 55 );
function bonipress_register_events_manager_light_hook( $installed ) {

	if ( ! function_exists( 'bp_em_init' ) ) return $installed;

	$installed['eventsmanager'] = array(
		'title'         => __( 'Events Manager', 'bonipress' ),
		'description'   => __( 'Awards %_plural% for users attending events.', 'bonipress' ),
		'documentation' => 'http://codex.bonipress.me/hooks/event-attendance/',
		'callback'      => array( 'boniPRESS_Hook_Events_Manager' )
	);
 ...
 * @version 1.3.1
 */
add_action( 'bonipress_load_hooks', 'bonipress_load_events_manager_light_hook', 55 );
function bonipress_load_events_manager_light_hook() {

	// If the hook has been replaced or if plugin is not installed, exit now
	if ( class_exists( 'boniPRESS_Hook_Events_Manager' ) || ! function_exists( 'bp_em_init' ) ) return;

	class boniPRESS_Hook_Events_Manager extends boniPRESS_Hook {
...
<div class="hook-instance">
	<h3><?php _e( 'Attending Event', 'bonipress' ); ?></h3>
	<div class="row">
		...
		<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( 'attend' => 'limit' ) ); ?>"><?php _e( 'Limit', 'bonipress' ); ?></label>
		...
		<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( 'attend' => 'log' ) ); ?>"><?php _e( 'Log template', 'bonipress' ); ?></label>
				<input type="text" name="<?php echo $this->field_name( array( 'attend' => 'log' ) ); ?>" id="<?php echo $this->field_id( array( 'attend' => 'log' ) ); ?>" placeholder="<?php _e( 'required', 'bonipress' ); ?>" value="<?php echo esc_attr( $prefs['attend']['log'] ); ?>" class="form-control" />
...
<div class="hook-instance">
	<h3><?php _e( 'Cancelling Attendance', 'bonipress' ); ?></h3>
	<div class="row">
		...
		<div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( 'cancel' => 'log' ) ); ?>"><?php _e( 'Log template', 'bonipress' ); ?></label>
				<input type="text" name="<?php echo $this->field_name( array( 'cancel' => 'log' ) ); ?>" id="<?php echo $this->field_id( array( 'cancel' => 'log' ) ); ?>" placeholder="<?php _e( 'required', 'bonipress' ); ?>" value="<?php echo esc_attr( $prefs['cancel']['log'] ); ?>" class="form-control" />
				<span class="description"><?php echo $this->available_template_tags( array( 'general', 'post' ) ); ?></span>
			</div>
		</div>
	</div>
