...
if ( defined( 'boniPRESS_VERSION' ) ) {
	 ...
	 * @version 1.0
	 */
	add_filter( 'bonipress_setup_hooks', 'GD_Star_boniPRESS_Hook' );
	function GD_Star_boniPRESS_Hook( $installed ) {
		$installed['gdstars'] = array(
			'title'       => __( 'GD Star Rating', 'bonipress' ),
			'description' => __( 'Awards %_plural% for users rate items using the GD Star Rating plugin.', 'bonipress' ),
			'callback'    => array( 'boniPRESS_Hook_GD_Star_Rating' )
		);
		return $installed;
	}
	 ...
	 * @version 1.0
	 */
	if ( ! class_exists( 'boniPRESS_Hook_GD_Star_Rating' ) && class_exists( 'boniPRESS_Hook' ) ) {
		class boniPRESS_Hook_GD_Star_Rating extends boniPRESS_Hook {
...
<label class="subheader" for="<?php echo $this->field_id( array( 'star_rating' => 'creds' ) ); ?>"><?php _e( 'Rating', 'bonipress' ); ?></label>
<ol>
	<li>
...
<label class="subheader" for="<?php echo $this->field_id( array( 'star_rating' => 'log' ) ); ?>"><?php _e( 'Protokollvorlage', 'bonipress' ); ?></label>
<ol>
	<li>
...
<label class="subheader" for="<?php echo $this->field_id( array( 'up_down' => 'creds' ) ); ?>"><?php _e( 'Up / Down Vote', 'bonipress' ); ?></label>
<ol>
	<li>
...
<label class="subheader" for="<?php echo $this->field_id( array( 'up_down' => 'log' ) ); ?>"><?php _e( 'Protokollvorlage', 'bonipress' ); ?></label>
<ol>
	<li>
