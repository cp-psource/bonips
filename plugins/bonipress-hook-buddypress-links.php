...
if ( defined( 'boniPRESS_VERSION' ) ) {
	 ...
	 * @version 1.0
	 */
	add_filter( 'bonipress_setup_hooks', 'BuddyPress_Links_boniPRESS_Hook' );
	function BuddyPress_Links_boniPRESS_Hook( $installed ) {

		$installed['hook_bp_links'] = array(
			'title'       => __( 'BuddyPress: Links', 'bonipress' ),
			'description' => __( 'Awards %_plural% for link related actions.', 'bonipress' ),
			'callback'    => array( 'boniPRESS_BuddyPress_Links' )
		);
	...
	/**
	 * boniPRESS_BuddyPress_Links class
	 * Creds for new links, voting on links, updating links and deleting links
	 * @since 0.1
	 * @version 1.1
	 */
	if ( ! class_exists( 'boniPRESS_BuddyPress_Links' ) && class_exists( 'boniPRESS_Hook' ) ) {
		class boniPRESS_BuddyPress_Links extends boniPRESS_Hook {

			/**
			 * Construct
			 */
			function __construct( $hook_prefs, $type = 'bonipress_default' ) {
			...
			public function vote_link( $link_id ) {
				...
				if ( $author == $bp->loggedin_user->id && apply_filters( 'bonipress_bp_link_self_vote', false ) === false ) return;
...
<!-- Creds for New Link -->
<label for="<?php echo $this->field_id( array( 'new_link', 'creds' ) ); ?>" class="subheader"><?php echo $this->core->template_tags_general( __( '%plural% for New Links', 'bonipress' ) ); ?></label>
<ol>
	<li>
	...
	<li class="empty">&nbsp;</li>
	<li>
		<label for="<?php echo $this->field_id( array( 'new_link', 'log' ) ); ?>"><?php _e( 'Log template', 'bonipress' ); ?></label>
...
<!-- Creds for Vote Link -->
<label for="<?php echo $this->field_id( array( 'vote_link', 'creds' ) ); ?>" class="subheader"><?php echo $this->core->template_tags_general( __( '%plural% for Vote on Link', 'bonipress' ) ); ?></label>
<ol>
	<li>
	...
	<li class="empty">&nbsp;</li>
	<li>
		<label for="<?php echo $this->field_id( array( 'vote_link', 'log' ) ); ?>"><?php _e( 'Log template', 'bonipress' ); ?></label>
...
<label for="<?php echo $this->field_id( array( 'vote_link_up', 'creds' ) ); ?>" class="subheader"><?php echo $this->core->template_tags_general( __( '%plural% per received Vote', 'bonipress' ) ); ?></label>
<ol>
	<li>
		<label><?php _e( 'Vote Up', 'bonipress' ); ?></label>
	...
	<li class="empty">&nbsp;</li>
	<li>
		<label for="<?php echo $this->field_id( array( 'vote_link_up', 'log' ) ); ?>"><?php _e( 'Log template', 'bonipress' ); ?></label>
	...
	<li class="empty">&nbsp;</li>
	<li>
		<label><?php _e( 'Vote Down', 'bonipress' ); ?></label>
	...
	<li class="empty">&nbsp;</li>
	<li>
		<label for="<?php echo $this->field_id( array( 'vote_link_down', 'log' ) ); ?>"><?php _e( 'Log template', 'bonipress' ); ?></label>
...
<label for="<?php echo $this->field_id( array( 'update_link', 'creds' ) ); ?>" class="subheader"><?php echo $this->core->template_tags_general( __( '%plural% for Updating Links', 'bonipress' ) ); ?></label>
<ol>
	<li>
	...
	<li class="empty">&nbsp;</li>
	<li>
		<label for="<?php echo $this->field_id( array( 'update_link', 'log' ) ); ?>"><?php _e( 'Log template', 'bonipress' ); ?></label>
...
<label for="<?php echo $this->field_id( array( 'delete_link', 'creds' ) ); ?>" class="subheader"><?php echo $this->core->template_tags_general( __( '%plural% for Deleting Links', 'bonipress' ) ); ?></label>
<ol>
	<li>
	...
	<li class="empty">&nbsp;</li>
	<li>
		<label for="<?php echo $this->field_id( array( 'delete_link', 'log' ) ); ?>"><?php _e( 'Log template', 'bonipress' ); ?></label>
