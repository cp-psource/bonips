...
/**
 * Addon: buyCRED
 * Addon URI: http://codex.bonips.me/chapter-iii/buycred/
 * Version: 1.6
 */
...
define( 'BONIPS_PURCHASE_DIR',          boniPS_ADDONS_DIR . 'buy-creds/' );
 ...
 * Load Dependencies
 */
require_once BONIPS_BUYCRED_ABSTRACT_DIR . 'bonips-abstract-payment-gateway.php';
...
do_action( 'bonips_buycred_load_gateways' );
