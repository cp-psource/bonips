 ...
 * @version 1.0
 */
if ( ! class_exists( 'boniPS_Hook_Delete_Content' ) ) :
	class boniPS_Hook_Delete_Content extends boniPS_Hook {
		public $defaults;
		...
		public function delete_content( $post_id ) {
			...
			$references = apply_filters( 'bonips_delete_hook_ref', 'deleted_content', $post, $this );
...
<div class="hook-instance">
	<h3><?php _e( 'Trashing Posts', 'bonips' ); ?></h3>
	<div class="row">
...
<div class="hook-instance">
	<h3><?php _e( 'Trashing Pages', 'bonips' ); ?></h3>
	<div class="row">
		<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
...
?>
<div class="hook-instance">
	<h3><?php printf( __( 'Trashing %s', 'bonips' ), $post_type->labels->name ); ?></h3>
	<div class="row">
		<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
