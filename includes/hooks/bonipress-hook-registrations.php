 ...
 * @version 1.2
 */
if ( ! class_exists( 'boniPRESS_Hook_Registration' ) ) :
	class boniPRESS_Hook_Registration extends boniPRESS_Hook {
		...
		public function registration( $user_id ) {
			...
			if ( $this->core->has_entry( 'registration', $user_id, $user_id, $data, $this->bonipress_type ) ) return;
