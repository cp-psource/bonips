 ...
 * @version 1.2
 */
if ( ! class_exists( 'boniPS_Hook_Publishing_Content' ) ) :
	class boniPS_Hook_Publishing_Content extends boniPS_Hook {
		public $defaults;
		...
		public function publishing_content( $new_status, $old_status, $post ) {
			...
			$status         = apply_filters( 'bonips_publish_hook_old', array( 'new', 'auto-draft', 'draft', 'private', 'pending', 'future' ), $post_id, $this->bonips_type );
			$publish_status = apply_filters( 'bonips_publish_hook_new', array( 'publish', 'private' ), $post_id, $this->bonips_type );
			$references     = apply_filters( 'bonips_publish_hook_ref', 'publishing_content', $post, $new_status, $old_status, $this );
			...
			if ( in_array( $old_status, $status ) && in_array( $new_status, $publish_status ) && array_key_exists( $post_type, $this->prefs ) ) {
				...
				if ( $this->core->has_entry( $references, $post_id, $user_id, $data, $this->bonips_type ) ) return;
...
<div class="hook-instance">
	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( 'post' => 'log' ) ); ?>"><?php _e( 'Protokollvorlage', 'bonips' ); ?></label>
...
<div class="hook-instance">
	<h3><?php _e( 'Publishing Pages', 'bonips' ); ?></h3>
	<div class="row">
		<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
		...
		<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( 'page' => 'log' ) ); ?>"><?php _e( 'Protokollvorlage', 'bonips' ); ?></label>
...
?>
<div class="hook-instance">
	<h3><?php printf( __( 'Publishing %s', 'bonips' ), $post_type->labels->name ); ?></h3>
	<div class="row">
		<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
		...
		<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( $post_type->name => 'log' ) ); ?>"><?php _e( 'Protokollvorlage', 'bonips' ); ?></label>
