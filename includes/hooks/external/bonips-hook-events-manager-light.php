 ...
 * @version 1.0.1
 */
add_filter( 'bonips_setup_hooks', 'bonips_register_events_manager_light_hook', 55 );
function bonips_register_events_manager_light_hook( $installed ) {

	if ( ! function_exists( 'bp_em_init' ) ) return $installed;

	$installed['eventsmanager'] = array(
		'title'         => __( 'Events Manager', 'bonips' ),
		'description'   => __( 'Awards %_plural% for users attending events.', 'bonips' ),
		'documentation' => 'http://codex.bonips.me/hooks/event-attendance/',
		'callback'      => array( 'boniPS_Hook_Events_Manager' )
	);
 ...
 * @version 1.3.1
 */
add_action( 'bonips_load_hooks', 'bonips_load_events_manager_light_hook', 55 );
function bonips_load_events_manager_light_hook() {

	// If the hook has been replaced or if plugin is not installed, exit now
	if ( class_exists( 'boniPS_Hook_Events_Manager' ) || ! function_exists( 'bp_em_init' ) ) return;

	class boniPS_Hook_Events_Manager extends boniPS_Hook {
...
<div class="hook-instance">
	<h3><?php _e( 'Attending Event', 'bonips' ); ?></h3>
	<div class="row">
		...
		<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( 'attend' => 'limit' ) ); ?>"><?php _e( 'Limit', 'bonips' ); ?></label>
		...
		<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( 'attend' => 'log' ) ); ?>"><?php _e( 'Protokollvorlage', 'bonips' ); ?></label>
				<input type="text" name="<?php echo $this->field_name( array( 'attend' => 'log' ) ); ?>" id="<?php echo $this->field_id( array( 'attend' => 'log' ) ); ?>" placeholder="<?php _e( 'erforderlich', 'bonips' ); ?>" value="<?php echo esc_attr( $prefs['attend']['log'] ); ?>" class="form-control" />
...
<div class="hook-instance">
	<h3><?php _e( 'Cancelling Attendance', 'bonips' ); ?></h3>
	<div class="row">
		...
		<div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( 'cancel' => 'log' ) ); ?>"><?php _e( 'Protokollvorlage', 'bonips' ); ?></label>
				<input type="text" name="<?php echo $this->field_name( array( 'cancel' => 'log' ) ); ?>" id="<?php echo $this->field_id( array( 'cancel' => 'log' ) ); ?>" placeholder="<?php _e( 'erforderlich', 'bonips' ); ?>" value="<?php echo esc_attr( $prefs['cancel']['log'] ); ?>" class="form-control" />
				<span class="description"><?php echo $this->available_template_tags( array( 'general', 'post' ) ); ?></span>
			</div>
		</div>
	</div>
