 ...
 * @version 1.2
 */
add_filter( 'bonipress_setup_hooks', 'bonipress_register_simplepress_hook', 85 );
function bonipress_register_simplepress_hook( $installed ) {

	if ( ! defined( 'SFTOPICS' ) ) return $installed;

	$installed['hook_simplepress'] = array(
		'title'         => 'Simple:Press',
		'description'   => __( 'Awards %_plural% for Simple:Press actions.', 'bonipress' ),
		'documentation' => 'http://codex.bonipress.me/hooks/simplepress-actions/',
		'callback'      => array( 'boniPRESS_SimplePress' )
	);
 ...
 * @version 1.2.1
 */
add_action( 'bonipress_load_hooks', 'bonipress_load_simplepress_hook', 85 );
function bonipress_load_simplepress_hook() {

	// If the hook has been replaced or if plugin is not installed, exit now
	if ( class_exists( 'boniPRESS_SimplePress' ) || ! defined( 'SFTOPICS' ) ) return;

	class boniPRESS_SimplePress extends boniPRESS_Hook {
		...
		public function run() {
			...
			add_filter( 'bonipress_parse_log_entry', array( $this, 'adjust_log_templates' ), 10, 2 );
...
<div class="hook-instance">
	<h3><?php _e( 'New Topic Post', 'bonipress' ); ?></h3>
	<div class="row">
		<div class="col-lg-2 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
...
<div class="hook-instance">
	<h3><?php _e( 'Deleted Topic Post', 'bonipress' ); ?></h3>
	<div class="row">
		<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
		...
		<div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( 'delete_post', 'log' ) ); ?>"><?php _e( 'Log template', 'bonipress' ); ?></label>
				<input type="text" name="<?php echo $this->field_name( array( 'delete_post', 'log' ) ); ?>" id="<?php echo $this->field_id( array( 'delete_post', 'log' ) ); ?>" placeholder="<?php _e( 'required', 'bonipress' ); ?>" value="<?php echo esc_attr( $prefs['delete_post']['log'] ); ?>" class="form-control" />
				<span class="description"><?php echo $this->available_template_tags( array( 'general' ) ); ?></span>
			</div>
		</div>
	</div>
