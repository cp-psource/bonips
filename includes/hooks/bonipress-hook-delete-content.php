 ...
 * @version 1.0
 */
if ( ! class_exists( 'boniPRESS_Hook_Delete_Content' ) ) :
	class boniPRESS_Hook_Delete_Content extends boniPRESS_Hook {
		...
		public function delete_content( $post_id ) {
			...
			$references = apply_filters( 'bonipress_delete_hook_ref', 'deleted_content', $post, $this );
...
<div class="hook-instance">
	<h3><?php _e( 'Trashing Posts', 'bonipress' ); ?></h3>
	<div class="row">
...
<div class="hook-instance">
	<h3><?php _e( 'Trashing Pages', 'bonipress' ); ?></h3>
	<div class="row">
		<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
...
?>
<div class="hook-instance">
	<h3><?php printf( __( 'Trashing %s', 'bonipress' ), $post_type->labels->name ); ?></h3>
	<div class="row">
		<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
