 ...
 * @version 1.3.1
 */
if ( ! class_exists( 'boniPRESS_Importer_Log_Entires' ) ) :
	class boniPRESS_Importer_Log_Entires extends WP_Importer {
			...
			if ( ( $handle = fopen( $file, "r" ) ) !== FALSE ) {
				...
				if ( sizeof( $header ) == 8 ) {
					...
					while ( ( $row = fgetcsv( $handle, 0, $this->delimiter ) ) !== false ) {
						...
						add_filter( 'bonipress_log_time',    array( $this, 'log_time' ) );

						$bonipress->add_to_log( $reference, $user_id, $amount, $entry, $ref_id, $data, $point_type );

						remove_filter( 'bonipress_log_time', array( $this, 'log_time' ) );
