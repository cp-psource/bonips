	...
	class boniPRESS_Widget_Balance extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				...
				sprintf( __( '(%s) My Balance', 'bonipress' ), bonipress_label( true ) ),
				array(
					'classname'   => 'widget-my-cred',
					'description' => __( 'Show the current users balance and history.', 'bonipress' )
				)
			);
...
<!-- Verlauf -->
<p class="boniPRESS-widget-field">
	<label for="<?php echo esc_attr( $this->get_field_id( 'show_history' ) ); ?>"><input type="checkbox" name="<?php echo esc_attr( $this->get_field_name( 'show_history' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'show_history' ) ); ?>" value="1"<?php checked( $show_history, 1 ); ?> class="checkbox" /> <?php _e( 'Include history', 'bonipress' ); ?></label>
</p>
<div id="<?php echo esc_attr( $this->get_field_id( 'show_history' ) ); ?>-details" class="bonipress-hidden<?php if ( $show_history == 1 ) echo ' ex-field'; ?>">
	...
	<p class="boniPRESS-widget-field">
		<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php _e( 'Number of entires', 'bonipress' ); ?>:</label>
	...
	<p class="boniPRESS-widget-field">
		<label for="<?php echo esc_attr( $this->get_field_id( 'history_format' ) ); ?>"><?php _e( 'Row layout', 'bonipress' ); ?>:</label>
