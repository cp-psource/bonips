...
wpWidgets = {
	...
	saveOrder : function( sidebarId ) {
		var data = {
			action: 'bonipress-hook-order',
			savewidgets: $('#_wpnonce_widgets').val(),
			ctype: boniPRESSHooks.type,
			sidebars: []
		};
		...
		$.post( ajaxurl, data, function(mho) {
			console.log( 'boniPRESS Hook Order' );
	...
	save : function( widget, del, animate, order ) {
		...
		$.post( ajaxurl, data, function(r) {
			var id;
			console.log( 'boniPRESS Save Hook' );
			if ( del ) {
	...
	removeInactiveWidgets : function() {
		...
		$.post( ajaxurl, data, function() {
			console.log( 'boniPRESS delete inactive Hook' );
